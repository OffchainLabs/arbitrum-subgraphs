...
export class Withdrawal extends Entity {
  ...
  get l2ToL1Event(): string | null {
    let value = this.get("l2ToL1Event");
    if (!value || value.kind == ValueKind.NULL) {
      return null;
    } else {
      return value.toString();
  ...
  set l2ToL1Event(value: string | null) {
    if (!value) {
      this.unset("l2ToL1Event");
    } else {
      this.set("l2ToL1Event", Value.fromString(<string>value));
    }
  }
}
